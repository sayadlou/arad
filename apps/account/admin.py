...
class MyUserAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_('Personal info'), {'fields': ('first_name', 'last_name', 'email', 'mobile', 'telegram_id')}),
        (_('Permissions'), {
    ...
    def whatsapp(self, user: UserProfile):
        if user.mobile:
            return format_html('<a href="https://wa.me/+98{}" target=”_blank”>چت</a>', user.mobile[1:])
        return "---"
